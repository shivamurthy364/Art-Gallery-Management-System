...
<div class="gal">
    <form action="artistdelete.php" method="post">
        <br/><br/><br/>
        <div class="lbl"> <label>Enter Artist ID:</label> </div>
        <div class="search-box">
            <input type="text" name="artistid" placeholder="G_ID">
        </div>
        <br><br><br/><br><br><br/>
    ...
    if($a!="")
        {
            ...
            echo "<b>Record with artisid = $a is deleted successfully.<b><br/><br/>";
            }
           else
        {
            echo "<b>!!!Error in Deleting Record!!!<br> Record '$a' was not found in database.<b><br/><br/>" ;
        }
        }
        else
        {
                echo "<b>Artist ID Field is Empty</b><br/><br/>";
            }
$con->close();
}
?>
