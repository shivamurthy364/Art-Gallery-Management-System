...
$con = mysqli_connect("localhost", "root", "", "art_gallery");
  ...
  if ($result = mysqli_query($con, $sql))
   ...
   while($row = $result->fetch_assoc())
    {
    echo "<tr><td>" . $row["gid"]. "</td><td>" . $row["gname"]. "</td><td><br>". $row["location"]. "<br></br></td>"."</td><td> <a href='$row[image]'><img src='". $row["image"]."' height='100' width='100'/></a>.</td></tr>";
    }
    echo "</table>";
    }
else
...
$con->close();
?>
     <a href="gallery.html"><u><-- Go Back </u></a>
</table>
