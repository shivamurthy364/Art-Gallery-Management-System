...
<div class="gal">
    <form action="artdelete.php" method="post">
        <br/><br/><br/>
        <div class="lbl"> <label>Enter Artwork ID:</label> </div>
        <div class="search-box">
            <input type="text" name="artid" placeholder="Art_ID">
        </div>
        <br><br><br/><br><br><br/>
...
$result =mysqli_query($con,$sql3);
  ...
  { 
    ...
    mysqli_query($con,$sql);
      echo "<b>Record with Art ID = $n is deleted successfully.<b><br><br>";
  }
   else
    {
      echo "<b>!!!Error in Deleting Record!!!<br> Record '$n' was not found in database.<b><br><br>" .mysqli_error($con);
    }
}
$con->close();
?>
