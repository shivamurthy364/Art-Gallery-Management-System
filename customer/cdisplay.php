...
<body class="sg">
<h1> DISPLAY CONTENTS /\/ CUSTOMER TABLE </h1>
<table class="table">
    <tr>
...
$con = mysqli_connect("localhost", "root", "", "art_gallery");
  ...
  if ($result = mysqli_query($con,"$sql"))
   ...
   while($row = $result->fetch_assoc())
    {
    echo "<tr><td>" . $row["custid"]. "</td><td>" . $row["gid"]. "</td><td>" . $row["fname"]. "</td><td>" . $row["lname"]. "</td><td>" . $row["dob"]. "</td><td>" . $row["address"]. "</td></tr>";
    }
    echo "</table>";
    }
else 
...
$con->close();
?>
    <a href="customer.html"><u><-- Go Back </u></a>
</table>
